const Me = () => {
  return (
    <div
      className="container mx-auto border-2 w-3/4 mt-20 p-0 border-black text-white rounded-lg"
    ...
    >
      ...
      <h1 className="m-4 ml-3">
        ...
        <span style={{ color: "#E5E5E5" }}>
          ...
          ability to solve problems. I am currently pursuing my bachelor's degree in computer science.
          Programming Languages efficiency in C++  in competitive (5🌟
          HackerRank, 3🌟 CodeChef), Java, Python, Javascript. Currently working
          on enhancing technical as well as interpersonal skills.
        </span>
      </h1>
    </div>
  );
